...
class CompatibilityTest < Minitest::Test
  class NonmarshallingPet < ActiveRecord::Base
    ...
    attr_encrypted :nickname,
      :key => proc { Encryptor.legacy_encrypt(:value => PET_NICKNAME_SALT, :key => PET_NICKNAME_KEY, insecure_mode: true, algorithm: 'aes-256-cbc') }
    attr_encrypted :birthdate,
      :key => proc { Encryptor.legacy_encrypt(:value => PET_BIRTHDATE_SALT, :key => PET_BIRTHDATE_KEY, insecure_mode: true, algorithm: 'aes-256-cbc') }
  end
