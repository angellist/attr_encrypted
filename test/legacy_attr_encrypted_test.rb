...
class LegacyAttrEncryptedTest < Minitest::Test
  ...
  def test_should_evaluate_a_key_passed_as_a_symbol
    ...
    assert_equal Encryptor.legacy_encrypt(:value => 'testing', :key => @user.salt, insecure_mode: true, algorithm: 'aes-256-cbc'), @user.ssn_encrypted
  end
  ...
  def test_should_evaluate_a_key_passed_as_a_proc
    ...
    assert_equal Encryptor.legacy_encrypt(:value => 'testing', :key => 'LegacyUser', insecure_mode: true, algorithm: 'aes-256-cbc'), @user.crypted_password_test
  end
  ...
  def test_should_encrypt_with_true_if
    ...
    assert_equal Encryptor.legacy_encrypt(:value => 'testing', :key => 'secret key', insecure_mode: true, algorithm: 'aes-256-cbc'), @user.encrypted_with_true_if
  end
  ...
  def test_should_encrypt_with_false_unless
    ...
    assert_equal Encryptor.legacy_encrypt(:value => 'testing', :key => 'secret key', insecure_mode: true, algorithm: 'aes-256-cbc'), @user.encrypted_with_false_unless
  end
