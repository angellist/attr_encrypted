...
class LegacyClient
  ...
  attr_encrypted :credentials, :key => Proc.new { |client| Encryptor.legacy_encrypt(:value => client.salt, :key => 'some private key', insecure_mode: true, algorithm: 'aes-256-cbc') }, :marshal => true, mode: :single_iv_and_salt
